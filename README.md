...
по умолчанию берётся из темы Telegram) и переключатель языка интерфейса
RU/EN — обе настройки хранятся в localStorage, реализация в
`web/src/lib/prefs.tsx` (цвета тем — CSS-переменные в
